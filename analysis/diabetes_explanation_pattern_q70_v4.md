...
Default boundary shortlist: closest 70% within each prediction over the full dataset. Overrides: none.
...
Selected 42 cases: 12 training and 30 testing per domain, with the required number from each prediction in every cluster.
