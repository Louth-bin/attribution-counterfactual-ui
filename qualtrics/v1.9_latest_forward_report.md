...
Fit identifiability: 0 participants have one supported model, 0 have two, and 25 have all three within ΔBIC < 2.

## Strict best model by domain and explanation

| Domain | XAI | N | Exemplar | Attribution | Prototype | One supported |
| --- | --- | --- | --- | --- | --- | --- |
| diabetes | attribution | 8 | 1 | 2 | 5 | 0 |
| diabetes | counterfactual | 10 | 1 | 9 | 0 | 0 |
| diabetes | none | 7 | 1 | 2 | 4 | 0 |
