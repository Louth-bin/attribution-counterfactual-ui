"""Isolate and remap the five new complete responses for v1.7 conversion."""
...
OUTPUT = ROOT / "qualtrics" / "v1.7_new_raw_remapped.csv"
SUMMARY = ROOT / "qualtrics" / "v1.7_new_raw_remapped_summary.json"
EXPECTED_NEW = 5
