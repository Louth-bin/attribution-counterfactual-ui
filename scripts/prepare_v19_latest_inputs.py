"""Isolate and remap only responses newly appended to the v1.9 cohort."""
...
RAW = ROOT / "qualtrics" / "raw_output_v1.7 (2 clusters new clustering).csv"
BUNDLE = ROOT / "analysis" / "diabetes-experiment-bundle-v1.6.json"
MANIFEST = ROOT / "qualtrics" / "case-manifest-v1.6.json"
PRESERVED = (
    ROOT / "qualtrics" / "qualtrics_results_v1.8.csv",
    ROOT / "qualtrics" / "v1.9_incremental_processed.csv",
)
OUTPUT = ROOT / "qualtrics" / "v1.9_append_raw_remapped.csv"
SUMMARY = ROOT / "qualtrics" / "v1.9_append_raw_remapped_summary.json"
EXPECTED_NEW = 11
